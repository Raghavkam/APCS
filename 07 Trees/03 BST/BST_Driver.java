   ...
   public static void main(String[] args)
   {
      ...
      for( String string : list )
      {
         ...
         System.out.println("in-order traversal: " + bst.toString());
          System.out.println("pre-order traversal: " + bst.preorderprint());//
           System.out.println("post-order traversal: " + bst.postorderprint());//
          System.out.println("post-order test: " + bst.preorderExtension(" C O PRAAASBBBCCCUCIMTENECE","ACIEBRNM"));//
         System.out.println("--------------------------");
      }
   }
}
